...
public static final long /*int*/ class_NSCalendar = objc_getClass("NSCalendar");
...
public static final long /*int*/ class_NSComparisonPredicate = objc_getClass("NSComparisonPredicate");
public static final long /*int*/ class_NSCompoundPredicate = objc_getClass("NSCompoundPredicate");
...
public static final long /*int*/ class_NSExpression = objc_getClass("NSExpression");
...
public static final long /*int*/ class_NSPopover = objc_getClass("NSPopover");
public static final long /*int*/ class_NSPredicate = objc_getClass("NSPredicate");
public static final long /*int*/ class_NSPredicateEditor = objc_getClass("NSPredicateEditor");
public static final long /*int*/ class_NSPredicateEditorRowTemplate = objc_getClass("NSPredicateEditorRowTemplate");
...
public static final long /*int*/ class_NSRuleEditor = objc_getClass("NSRuleEditor");
...
public static final long /*int*/ class_NSTokenField = objc_getClass("NSTokenField");
...
public static final long /*int*/ class_NSViewController = objc_getClass("NSViewController");
...
public static final long /*int*/ protocol_NSKeyValueBindingCreation = objc_getProtocol("NSKeyValueBindingCreation");
public static final long /*int*/ protocol_NSKeyValueCoding = objc_getProtocol("NSKeyValueCoding");
...
public static final long /*int*/ protocol_NSTokenFieldDelegate = objc_getProtocol("NSTokenFieldDelegate");
...
public static final long /*int*/ sel_addRow_ = sel_registerName("addRow:");
...
public static final long /*int*/ sel_animates = sel_registerName("animates");
public static final long /*int*/ sel_appearance = sel_registerName("appearance");
...
public static final long /*int*/ sel_behavior = sel_registerName("behavior");
...
public static final long /*int*/ sel_bind_toObject_withKeyPath_options_ = sel_registerName("bind:toObject:withKeyPath:options:");
...
public static final long /*int*/ sel_calendar = sel_registerName("calendar");
...
public static final long /*int*/ sel_canRemoveAllRows = sel_registerName("canRemoveAllRows");
...
public static final long /*int*/ sel_collection = sel_registerName("collection");
...
public static final long /*int*/ sel_commitEditing = sel_registerName("commitEditing");
public static final long /*int*/ sel_commitEditingWithDelegate_didCommitSelector_contextInfo_ = sel_registerName("commitEditingWithDelegate:didCommitSelector:contextInfo:");
public static final long /*int*/ sel_compare_ = sel_registerName("compare:");
public static final long /*int*/ sel_comparisonPredicateModifier = sel_registerName("comparisonPredicateModifier");
public static final long /*int*/ sel_components_fromDate_ = sel_registerName("components:fromDate:");
public static final long /*int*/ sel_componentsJoinedByString_ = sel_registerName("componentsJoinedByString:");
public static final long /*int*/ sel_compoundPredicateType = sel_registerName("compoundPredicateType");
...
public static final long /*int*/ sel_constantValue = sel_registerName("constantValue");
...
public static final long /*int*/ sel_contentViewController = sel_registerName("contentViewController");
...
public static final long /*int*/ sel_copyWithZone_ = sel_registerName("copyWithZone:");
...
public static final long /*int*/ sel_criteriaForRow_ = sel_registerName("criteriaForRow:");
public static final long /*int*/ sel_criteriaKeyPath = sel_registerName("criteriaKeyPath");
...
public static final long /*int*/ sel_currentCalendar = sel_registerName("currentCalendar");
...
public static final long /*int*/ sel_dateFromComponents_ = sel_registerName("dateFromComponents:");
public static final long /*int*/ sel_datePickerStyle = sel_registerName("datePickerStyle");
...
public static final long /*int*/ sel_dateWithTimeIntervalSince1970_ = sel_registerName("dateWithTimeIntervalSince1970:");
public static final long /*int*/ sel_dateWithTimeIntervalSinceNow_ = sel_registerName("dateWithTimeIntervalSinceNow:");
public static final long /*int*/ sel_dateWithTimeIntervalSinceReferenceDate_ = sel_registerName("dateWithTimeIntervalSinceReferenceDate:");
...
public static final long /*int*/ sel_detachableWindowForPopover_ = sel_registerName("detachableWindowForPopover:");
...
public static final long /*int*/ sel_discardEditing = sel_registerName("discardEditing");
...
public static final long /*int*/ sel_displayValuesForRow_ = sel_registerName("displayValuesForRow:");
public static final long /*int*/ sel_displayValuesKeyPath = sel_registerName("displayValuesKeyPath");
...
public static final long /*int*/ sel_evaluateWithObject_ = sel_registerName("evaluateWithObject:");
...
public static final long /*int*/ sel_expressionForConstantValue_ = sel_registerName("expressionForConstantValue:");
public static final long /*int*/ sel_expressionForFunction_arguments_ = sel_registerName("expressionForFunction:arguments:");
public static final long /*int*/ sel_expressionForKeyPath_ = sel_registerName("expressionForKeyPath:");
public static final long /*int*/ sel_expressionType = sel_registerName("expressionType");
public static final long /*int*/ sel_expressionValueWithObject_context_ = sel_registerName("expressionValueWithObject:context:");
...
public static final long /*int*/ sel_formattingDictionary = sel_registerName("formattingDictionary");
public static final long /*int*/ sel_formattingStringsFilename = sel_registerName("formattingStringsFilename");
...
public static final long /*int*/ sel_initWithCalendarIdentifier_ = sel_registerName("initWithCalendarIdentifier:");
...
public static final long /*int*/ sel_initWithCompoundTypes_ = sel_registerName("initWithCompoundTypes:");
...
public static final long /*int*/ sel_initWithLeftExpression_rightExpression_modifier_type_options_ = sel_registerName("initWithLeftExpression:rightExpression:modifier:type:options:");
public static final long /*int*/ sel_initWithLeftExpressions_rightExpressionAttributeType_modifier_operators_options_ = sel_registerName("initWithLeftExpressions:rightExpressionAttributeType:modifier:operators:options:");
public static final long /*int*/ sel_initWithLeftExpressions_rightExpressions_modifier_operators_options_ = sel_registerName("initWithLeftExpressions:rightExpressions:modifier:operators:options:");
...
public static final long /*int*/ sel_initWithNibName_bundle_ = sel_registerName("initWithNibName:bundle:");
...
public static final long /*int*/ sel_initWithType_subpredicates_ = sel_registerName("initWithType:subpredicates:");
...
public static final long /*int*/ sel_insertRowAtIndex_withType_asSubrowOfRow_animate_ = sel_registerName("insertRowAtIndex:withType:asSubrowOfRow:animate:");
...
public static final long /*int*/ sel_isAlternate = sel_registerName("isAlternate");
...
public static final long /*int*/ sel_isEditable = sel_registerName("isEditable");
...
public static final long /*int*/ sel_isShown = sel_registerName("isShown");
...
public static final long /*int*/ sel_keyPath = sel_registerName("keyPath");
...
public static final long /*int*/ sel_leftExpression = sel_registerName("leftExpression");
public static final long /*int*/ sel_leftExpressions = sel_registerName("leftExpressions");
...
public static final long /*int*/ sel_loadView = sel_registerName("loadView");
...
public static final long /*int*/ sel_longLongValue = sel_registerName("longLongValue");
public static final long /*int*/ sel_longValue = sel_registerName("longValue");
...
public static final long /*int*/ sel_matchForPredicate_ = sel_registerName("matchForPredicate:");
...
public static final long /*int*/ sel_modifier = sel_registerName("modifier");
...
public static final long /*int*/ sel_nestingMode = sel_registerName("nestingMode");
...
public static final long /*int*/ sel_nibBundle = sel_registerName("nibBundle");
public static final long /*int*/ sel_nibName = sel_registerName("nibName");
...
public static final long /*int*/ sel_objectValue = sel_registerName("objectValue");
...
public static final long /*int*/ sel_operators = sel_registerName("operators");
...
public static final long /*int*/ sel_parentRowForRow_ = sel_registerName("parentRowForRow:");
...
public static final long /*int*/ sel_performClose_ = sel_registerName("performClose:");
...
public static final long /*int*/ sel_popoverDidClose_ = sel_registerName("popoverDidClose:");
public static final long /*int*/ sel_popoverDidShow_ = sel_registerName("popoverDidShow:");
public static final long /*int*/ sel_popoverShouldClose_ = sel_registerName("popoverShouldClose:");
public static final long /*int*/ sel_popoverWillClose_ = sel_registerName("popoverWillClose:");
public static final long /*int*/ sel_popoverWillShow_ = sel_registerName("popoverWillShow:");
public static final long /*int*/ sel_port = sel_registerName("port");
public static final long /*int*/ sel_positioningRect = sel_registerName("positioningRect");
public static final long /*int*/ sel_postEvent_atStart_ = sel_registerName("postEvent:atStart:");
public static final long /*int*/ sel_predicate = sel_registerName("predicate");
public static final long /*int*/ sel_predicateForRow_ = sel_registerName("predicateForRow:");
public static final long /*int*/ sel_predicateFormat = sel_registerName("predicateFormat");
public static final long /*int*/ sel_predicateOperatorType = sel_registerName("predicateOperatorType");
public static final long /*int*/ sel_predicateWithFormat_ = sel_registerName("predicateWithFormat:");
...
public static final long /*int*/ sel_reloadCriteria = sel_registerName("reloadCriteria");
...
public static final long /*int*/ sel_reloadPredicate = sel_registerName("reloadPredicate");
...
public static final long /*int*/ sel_removeRowAtIndex_ = sel_registerName("removeRowAtIndex:");
public static final long /*int*/ sel_removeRowsAtIndexes_includeSubrows_ = sel_registerName("removeRowsAtIndexes:includeSubrows:");
...
public static final long /*int*/ sel_replaceObjectAtIndex_withObject_ = sel_registerName("replaceObjectAtIndex:withObject:");
...
public static final long /*int*/ sel_representedObject = sel_registerName("representedObject");
...
public static final long /*int*/ sel_rightExpression = sel_registerName("rightExpression");
public static final long /*int*/ sel_rightExpressionAttributeType = sel_registerName("rightExpressionAttributeType");
public static final long /*int*/ sel_rightExpressions = sel_registerName("rightExpressions");
...
public static final long /*int*/ sel_rowClass = sel_registerName("rowClass");
public static final long /*int*/ sel_rowForDisplayValue_ = sel_registerName("rowForDisplayValue:");
...
public static final long /*int*/ sel_rowTemplates = sel_registerName("rowTemplates");
public static final long /*int*/ sel_rowTypeForRow_ = sel_registerName("rowTypeForRow:");
public static final long /*int*/ sel_rowTypeKeyPath = sel_registerName("rowTypeKeyPath");
...
public static final long /*int*/ sel_setAlternate_ = sel_registerName("setAlternate:");
public static final long /*int*/ sel_setAlternateButtonTitle_ = sel_registerName("setAlternateButtonTitle:");
public static final long /*int*/ sel_setAnimates_ = sel_registerName("setAnimates:");
public static final long /*int*/ sel_setAppearance_ = sel_registerName("setAppearance:");
...
public static final long /*int*/ sel_setBehavior_ = sel_registerName("setBehavior:");
...
public static final long /*int*/ sel_setCanRemoveAllRows_ = sel_registerName("setCanRemoveAllRows:");
...
public static final long /*int*/ sel_setContentSize_ = sel_registerName("setContentSize:");
public static final long /*int*/ sel_setContentView_ = sel_registerName("setContentView:");
public static final long /*int*/ sel_setContentViewController_ = sel_registerName("setContentViewController:");
...
public static final long /*int*/ sel_setCriteria_andDisplayValues_forRowAtIndex_ = sel_registerName("setCriteria:andDisplayValues:forRowAtIndex:");
public static final long /*int*/ sel_setCriteriaKeyPath_ = sel_registerName("setCriteriaKeyPath:");
...
public static final long /*int*/ sel_setDisplayValuesKeyPath_ = sel_registerName("setDisplayValuesKeyPath:");
...
public static final long /*int*/ sel_setFormattingDictionary_ = sel_registerName("setFormattingDictionary:");
public static final long /*int*/ sel_setFormattingStringsFilename_ = sel_registerName("setFormattingStringsFilename:");
...
public static final long /*int*/ sel_setNestingMode_ = sel_registerName("setNestingMode:");
...
public static final long /*int*/ sel_setPositioningRect_ = sel_registerName("setPositioningRect:");
public static final long /*int*/ sel_setPredicate_ = sel_registerName("setPredicate:");
...
public static final long /*int*/ sel_setRepresentedObject_ = sel_registerName("setRepresentedObject:");
...
public static final long /*int*/ sel_setRowClass_ = sel_registerName("setRowClass:");
public static final long /*int*/ sel_setRowHeight_ = sel_registerName("setRowHeight:");
public static final long /*int*/ sel_setRowTemplates_ = sel_registerName("setRowTemplates:");
public static final long /*int*/ sel_setRowTypeKeyPath_ = sel_registerName("setRowTypeKeyPath:");
...
public static final long /*int*/ sel_setSubrowsKeyPath_ = sel_registerName("setSubrowsKeyPath:");
...
public static final long /*int*/ sel_setTimeZone_ = sel_registerName("setTimeZone:");
...
public static final long /*int*/ sel_showRelativeToRect_ofView_preferredEdge_ = sel_registerName("showRelativeToRect:ofView:preferredEdge:");
...
public static final long /*int*/ sel_stringWithString_ = sel_registerName("stringWithString:");
...
public static final long /*int*/ sel_subpredicates = sel_registerName("subpredicates");
public static final long /*int*/ sel_subrowIndexesForRow_ = sel_registerName("subrowIndexesForRow:");
public static final long /*int*/ sel_subrowsKeyPath = sel_registerName("subrowsKeyPath");
...
public static final long /*int*/ sel_templateViews = sel_registerName("templateViews");
...
public static final long /*int*/ sel_timeIntervalSince1970 = sel_registerName("timeIntervalSince1970");
...
public static final long /*int*/ sel_tokenField_completionsForSubstring_indexOfToken_indexOfSelectedItem_ = sel_registerName("tokenField:completionsForSubstring:indexOfToken:indexOfSelectedItem:");
public static final long /*int*/ sel_tokenField_shouldAddObjects_atIndex_ = sel_registerName("tokenField:shouldAddObjects:atIndex:");
...
public static final long /*int*/ sel_unbind_ = sel_registerName("unbind:");
...
public static final double CGFLOAT_MAX = 3.4028235E+38;
 ...
 */
public static final native long /*int*/ CFNumberGetType(long /*int*/ number);
/**
 ...
 * @param x cast=(CGFloat)
 * @param y cast=(CGFloat)
 * @param w cast=(CGFloat)
 * @param h cast=(CGFloat)
 */
public static final native NSRect NSMakeRect(double /*float*/ x, double /*float*/ y, double /*float*/ w, double /*float*/ h);
/**
