...
public NSTokenField(long /*int*/ id) {
	super(id);
}

public NSTokenField(id id) {
	super(id);
}
...
public static long /*int*/ cellClass() {
	return OS.objc_msgSend(OS.class_NSTokenField, OS.sel_cellClass);
}

public static void setCellClass(long /*int*/ factoryId) {
	OS.objc_msgSend(OS.class_NSTokenField, OS.sel_setCellClass_, factoryId);
}
