...
public class SWTWeightRowTemplate extends NSPredicateEditorRowTemplate {
    ...
    public SWTWeightRowTemplate(HashMap<String, String> keyPathToTitleMap, List<String> units) {
        super(0);
        alloc();
    ...
    long /*int*/ copyWithZoneProc(long /*int*/ arg0) {
    	SWTWeightRowTemplate newTemplate = new SWTWeightRowTemplate(keyPathToTitleMap, units);
