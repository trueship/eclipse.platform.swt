...
public class CallbackFpret {
	...
	static final String RET_SIGNATURE = C.PTR_SIZEOF == 4 ? "F" : "D";
	...
	static final String SIGNATURE_N = "(["+PTR_SIGNATURE+")"+RET_SIGNATURE; //$NON-NLS-1$  //$NON-NLS-2$
 ...
 */
public CallbackFpret (Object object, String method, int argCount) {
 ...
 */
public CallbackFpret (Object object, String method, int argCount, boolean isArrayBased) {
 ...
 */
public CallbackFpret (Object object, String method, int argCount, boolean isArrayBased, long /*int*/ errorResult) {
 ...
 */
static native synchronized long /*int*/ bind (CallbackFpret callback, Object object, String method, String signature, int argCount, boolean isStatic, boolean isArrayBased, long /*int*/ errorResult);
...
static String getSignature(int argCount) {
	...
	signature += ")" + RET_SIGNATURE; //$NON-NLS-1$
	return signature;
}
 ...
 * @see #dispose
 */
static final native synchronized void unbind (CallbackFpret callback);
